...
def sent_report(cookies):
    ...
    params = {
        ...
        "city":"商洛市",
        "province":"陕西省",
        "address":"陕西省商洛市山阳县中村镇烟囱沟",
        "geo_api_info":'{"type":"complete","info":"SUCCESS","status":1,"$Da":"jsonp_687452_","message":"Get ipLocation success.Get address success.","location_type":"ip","accuracy":null,"isConverted":true,"addressComponent":{"citycode":"0914","adcode":"611024","businessAreas":[],"neighborhoodType":"","neighborhood":"","building":"","buildingType":"","street":"","streetNumber":"","country":"中国","province":"陕西省","city":"商洛市","district":"山阳县","township":"中村镇"},"formattedAddress":"陕西省商洛市山阳县中村镇烟囱沟","roads":[],"crosses":[],"pois":[]}',   #高德SDK返回值
        "sfcyglq":"0",  #是否隔离期
        "sfyzz":"0",    #是否有症状
        "qtqk":"",  #其他情况
        "ymtys":""  #不明（可能是一码通颜色，暂无用）
